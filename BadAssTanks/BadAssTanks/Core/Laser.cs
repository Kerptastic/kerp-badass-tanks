...
namespace BadAssTanks
{
    ...
    {        
        ...
        public Laser(Device device, int worldX, int worldY, float tileX, float tileY, float angle)
        {
            ...
            points.Add(new Vector(-1.0f, 4.5f));
            points.Add(new Vector(1.0f, 4.5f));
            points.Add(new Vector(1.0f, -4.5f));
            points.Add(new Vector(-1.0f, -4.5f));
            ...
            m_boundingShape.Translate(new Vector(((float)(m_laserWorldCoords.x + m_laserTileCoords.x)), ((float)(m_laserWorldCoords.y + m_laserTileCoords.y))));
        ...
        public override void Move(float angle)
        {
            ...
            Vector move = new Vector(m_xMove, m_yMove);
