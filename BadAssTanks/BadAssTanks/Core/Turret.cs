...
namespace BadAssTanks
{
    class Turret : WorldObject
    {
        ...
        public Turret(Device device, int worldTileStartX, int worldTileStartY)
        {
            ...
            points.Add(new Vector((m_turretWidth-300) / 1000.0f, (m_turretHeight-300) / 1000.0f));
            points.Add(new Vector((m_turretWidth-300) / 1000.0f, (-m_turretHeight+300) / 1000.0f));
            points.Add(new Vector((-m_turretWidth+300) / 1000.0f, (-m_turretHeight+300) / 1000.0f));
            points.Add(new Vector((-m_turretWidth+300) / 1000.0f, (m_turretHeight-300) / 1000.0f));
            ...
            m_boundingShape.Translate(new Vector((float)m_turretWorldCoords.x + 0.5f, (float)m_turretWorldCoords.y + 0.5f));
