...
namespace BadAssTanks
{
    class BossBot : WorldObject
    {
        ...
        public BossBot(Device device, int worldTileStartX, int worldTileStartY)
        {
            ...
            List<Vector> headPoints = new List<Vector>();
            List<Vector> leftTurretPoints = new List<Vector>();
            List<Vector> rightTurretPoints = new List<Vector>();

            headPoints.Add(new Vector((-m_headWidth+1400) / 1000.0f, (m_headHeight-1400) / 1000.0f));
            headPoints.Add(new Vector((m_headWidth-1400) / 1000.0f, (m_headHeight-1400) / 1000.0f));
            headPoints.Add(new Vector((m_headWidth-1400) / 1000.0f, (-m_headHeight+1400) / 1000.0f));
            headPoints.Add(new Vector((-m_headWidth+1400) / 1000.0f, (-m_headHeight+1400) / 1000.0f));

            leftTurretPoints.Add(new Vector((-m_turretWidth+700) / 1000.0f, (m_turretHeight-700) / 1000.0f));
            leftTurretPoints.Add(new Vector((m_turretWidth-700) / 1000.0f, (m_turretHeight-700) / 1000.0f));
            leftTurretPoints.Add(new Vector((m_turretWidth-700) / 1000.0f, (-m_turretHeight+700) / 1000.0f));
            leftTurretPoints.Add(new Vector((-m_turretWidth+700) / 1000.0f, (-m_turretHeight+700) / 1000.0f));

            rightTurretPoints.Add(new Vector((-m_turretWidth+700) / 1000.0f, (m_turretHeight-700) / 1000.0f));
            rightTurretPoints.Add(new Vector((m_turretWidth-700) / 1000.0f, (m_turretHeight-700) / 1000.0f));
            rightTurretPoints.Add(new Vector((m_turretWidth-700) / 1000.0f, (-m_turretHeight+700) / 1000.0f));
            rightTurretPoints.Add(new Vector((-m_turretWidth+700) / 1000.0f, (-m_turretHeight+700) / 1000.0f));
            ...
            m_boundingShape.Translate(new Vector((float)m_robotWorldCoords.x, (float)m_robotWorldCoords.y));
            m_leftTurretShape.Translate(new Vector((float)m_robotWorldCoords.x + 2.0f, (float)m_robotWorldCoords.y));
            m_rightTurretShape.Translate(new Vector((float)m_robotWorldCoords.x - 2.0f, (float)m_robotWorldCoords.y));
        ...
        public override void Move(WorldObject obj)
        {
            ...
            if (m_rightShoulderTurret != null)
            {
                ...
                Vector move = new Vector(xChange, yChange);
