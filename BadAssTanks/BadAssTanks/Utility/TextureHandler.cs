...
namespace BadAssTanks
{
    ...
    public class TextureHandler
    {
        ...
        //{
        //    m_waterImageStrings = new ArrayList();
        //    m_waterTextures = new ArrayList();
        //    m_unanimatedImages = new ArrayList();
        //    m_animatedImages = new ArrayList();
        //    m_camoTankImages = new ArrayList();
        //    m_blueRedTankImages = new ArrayList();
        //    m_greenYellowTankImages = new ArrayList();
        //    m_tankDamage = new ArrayList();
        //    m_bulletImages = new ArrayList();
        //    m_missileImages = new ArrayList();
        //    m_titleImages = new ArrayList();
        //    m_smokeImages = new ArrayList();
        //    m_explosionImages = new ArrayList();
        //    m_robotImages = new ArrayList();
        //    m_robotHeadImages = new ArrayList();
        //    m_turretImages = new ArrayList();
        //    m_explosionImages = new ArrayList();
        //    m_laserImages = new ArrayList();
        //    m_upgrades = new ArrayList();
        //}

        /// <summary>
        /// Retrieves the instance of this class. If this is the first call, it will
        /// instantiate the TextureHandler instance.
        /// </summary>
        /// <returns>The instance of the Texture Handler.</returns>
